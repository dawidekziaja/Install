...
##fast change the editions
echo -ne '#######                   (30%)\r'
git clone -b $edition --single-branch https://github.com/dawidekziaja/Install.git /opt/pgstage 1>/dev/null 2>&1
git clone https://github.com/dawidekziaj/PTS-Update.git /opt/ptsupdate 1>/dev/null 2>&1
echo -ne '##########                (40%)\r'
